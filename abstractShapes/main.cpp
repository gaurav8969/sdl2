...
int main(int argc, char* argv[]){;
    ...
    TexturedRectangle rectangle(surface,texture,renderer);
    rectangle.setRectangleProperties(100,200,300,300);

    TexturedRectangle rectangle2("/home/yash/repos/sdl2/abstractShapes/images/waterTexture.bmp", renderer);
    rectangle2.setRectangleProperties(300,0,200,200);

    std::vector<std::unique_ptr<TexturedRectangle>>rects;

    for(int i = 0; i < 40; i++){
        std::unique_ptr<TexturedRectangle> rect = std::make_unique<TexturedRectangle>("/home/yash/repos/sdl2/abstractShapes/images/waterTexture.bmp", renderer);
